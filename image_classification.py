...
def main():
    ...
    if uploaded_file is not None:
        ...
        pred3 = round(prediction[3],3) * 100  # CBR400Rの確率(%) <--バイク
        ...
        if classNo == 0:
            ...
            st.subheader(f"これは{pred3}%の確率で「CBR400R」です!")
...
# 学科：高度情報工学科
# 学年：４年
# コメント：エラーなどの対処が非常に苦戦しました。
# 　　　　　また、前期はいくつか制作課題が平行していたので
# 　　　　　その点、頭が混乱する場面が多くありました。
# 　　　　
#
#=============================================================================#
